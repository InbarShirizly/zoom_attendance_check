...
class TestAttendance:
    ...
    chat_files_start_indices = [
        ("chat_file_valid.txt", "example_excel.xlsx", 1, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"], 3),
        ("chat_file_valid.txt", "example_excel.xlsx", 1, "בדיקת נוכחות", ["Roei teacher", "Idan Aviv"], 4),
        ("chat_file_valid.txt", "example_excel.xlsx", 1, "check", ["Roei teacher"], 0),
        ("chat_file_valid_english_nba.txt", "example_excel_english.xlsx", 1, "Attendance check", ["Roei teacher", "Elad Visitor"], 3)
    ]

    @pytest.mark.parametrize(("chat_file_name", "excel_file_name", "time_delta", "start_sentence", "zoom_names_to_ignore", "num_sessions"), chat_files_start_indices)
    def test_get_start_indices(self, folders, chat_df_func, df_students_func, filter_modes,
                               chat_file_name, excel_file_name, time_delta, start_sentence, zoom_names_to_ignore, num_sessions):
        chat_df = chat_df_func(os.path.join(folders["chat_folder"], chat_file_name))
        student_df = df_students_func(excel_file_name)
    ...
    chat_files_time_segment_rows = [
        ("chat_file_valid.txt", "example_excel.xlsx", 1, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"], [5, 7, 6]),
        ("chat_file_valid.txt", "example_excel.xlsx", 1, "בדיקת נוכחות", ["Roei teacher", "Idan Aviv"], [5, 7, 3, 3]),
        ("chat_file_valid.txt", "example_excel.xlsx", 1, "check", ["Roei teacher"], 0),
        ("chat_file_valid.txt", "example_excel.xlsx", 3, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"], [6, 9, 6]),
        ("chat_file_valid_english_nba.txt", "example_excel_english.xlsx", 1, "Attendance check", ["Roei teacher", "Elad Visitor"], [5, 7, 6])
    ]

    @pytest.mark.parametrize(("chat_file_name", "excel_file_name", "time_delta",
    ...
    def test_get_df_of_time_segment(self, folders, chat_df_func, df_students_func, filter_modes,
                               chat_file_name, excel_file_name, time_delta, start_sentence, zoom_names_to_ignore, list_rows_in_session):
        chat_df = chat_df_func(os.path.join(folders["chat_folder"], chat_file_name))
        student_df = df_students_func(excel_file_name)
        meta_data = AttendanceMetaData(filter_modes=filter_modes, time_delta=time_delta,
                                       start_sentence=start_sentence, zoom_names_to_ignore=zoom_names_to_ignore)
    ...
    chat_files_status_test = [
        ("chat_file_valid.txt", "example_excel.xlsx", 1, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"], [1, 1, 2, 1, 1, 0, 0]),
        ("chat_file_valid.txt", "example_excel.xlsx", 2, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"], [1, 1, 2, 1, 1, 0, 1]),
        ("chat_file_valid.txt", "example_excel.xlsx", 4, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"], [1, 1, 2, 1, 1, 1, 1]),
        ("chat_file_valid.txt", "example_excel.xlsx", 5, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"], [1, 1, 2, 1, 1, 2, 1]),
        ("chat_file_valid_english_nba.txt", "example_excel_english.xlsx", 1, "Attendance check", ["Roei teacher", "Elad Visitor"], [1, 2, 0, 1, 2, 0, 1])
        ]
