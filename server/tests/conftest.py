...
from app.parsing.utils import create_students_df, create_chat_df
import os


@pytest.fixture
def folders():
    chat_files_folder = os.path.join("tests", "files_to_test", "chat_files")
    student_list_files_folder = os.path.join("tests", "files_to_test", "students_list_excel")
