...
class TestSession:
    ...
    chat_files_data_session_start_time = [
        ...
        ("chat_file_valid.txt", 5, "בדיקת נוכחות", ["Idan Aviv"],
         [(11, 57, 45)])

    ]

    @pytest.mark.parametrize(("file_name", "time_delta", "start_sentence",
    ...
    def test_first_message_time(self, folders, student_df, chat_df_func, filter_modes,
                                file_name, time_delta, start_sentence, zoom_names_to_ignore, message_time_tuples_list):
    ...
    chat_files_data_session = [
        ...
        ("chat_file_valid.txt", 3, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"],
         {"total_messages": (5, 8, 4), "relevant_messages": (4, 5, 2)}),

        ("chat_file_valid.txt", 5, "בדיקת נוכחות", ["Roei teacher", "Elad Visitor"],
    ...
    def test_get_relevant_chat_in_session(self, folders, student_df, chat_df_func, filter_modes,
                                file_name, time_delta, start_sentence, zoom_names_to_ignore, counting_dict):
