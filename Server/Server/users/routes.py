...
def login():
    ...
    if form.validate_on_submit():
        user = TeacherModel.query.filter_by(email=form.auth.data).first() or \
         TeacherModel.query.filter_by(username=form.auth.data).first() # User can be validated with both username and email
